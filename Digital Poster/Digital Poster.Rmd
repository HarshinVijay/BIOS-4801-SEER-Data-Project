...
- Clinical guidelines suggest that start of treatment beyond 42 days post-diagnosis is associated with worse overall survival (OS). 

- This study uses population-based data to quantify the hazard associated with this treatment delay threshold.
